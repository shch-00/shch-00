...
<p align="center">Фронтенд-разработчик (React) | HTML-Верстальщик | Стремлюсь в сферу AI/ML</p>
 ...
 - Стэк: HTML, CSS, JavaScript, TypeScript, React, NextJs, сейчас глубже погружаюсь в БД (MySQL, Postgre)
 - Путешествовал по России и миру, люблю знакомиться с новыми культурами
 - Люблю учиться, решать нестандартные задачи и помогать другим
 - Опыт работы верстальщиком более 2-х лет
